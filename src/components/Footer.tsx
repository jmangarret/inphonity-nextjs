  ...
  return (
    <footer className="bg-white text-xs lg:text-sm font-medium">
      <div className="text-xs md:text-base py-3 md:py-6 text-center lg:text-left" style={{background: '#298A9A'}}>
        <div
          className={`md:w-3/4 mx-auto grid grid-cols-8 gap-4 flex items-center`}
        >
          ...
          <div className="col-span-12 sm:col-span-4 lg:col-span-1 md:col-span-4 text-center flex flex-col items-center">
      ...
      <nav className="container mx-auto p-4 text-center flex items-center">
        <ul className="flex flex-wrap items-center justify-center mx-auto">
          <li className="w-1/2 border-gray-400 border-r md:mb-4 lg:my-4 xl:my-2 sm:my-4 my-4 lg:w-auto px-5 lg:px-16 text-center flex flex-col items-center">
            <a
          ...
          <li className="w-1/2 lg:w-auto px-5 lg:px-16 text-center md:mb-4 lg:my-4 xl:my-2 sm:my-4 my-4 border-gray-400 lg:border-r flex flex-col items-center">
            <a
          ...
          <li className="px-5 lg:px-16 mt-5 lg:mt-0 flex flex-col items-center md:mb-4 lg:my-4 xl:my-2 sm:my-4 my-4 text-center">
