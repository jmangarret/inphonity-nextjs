...
const InvitationSection: React.FC<InvitationSectionProps> = ({invitationId}) => {
  ...
  return (
    <section
      className="p-3 sm:p-6 md:p-8 lg:p-10 xl:p-12 bg-vertical-gradient"
    >
      <div
      ...
      >
        <div className="grid grid-cols-12 gap-3 text-center">
          ...
          <div className={`col-span-12 md:col-span-10`}>
            <h2
              className="font-medium text-2xl sm:text-3xl lg:text-5xl mb-8 sm:mb-12 md:mb-16 lg:mb-20 text-center mt-6 lg:mt-8 xl:mt-10"
            >
              Haz realidad todo lo que
              <br/>
              <span className={`text-highlight`}>siempre imaginaste</span>
            </h2>
          </div>
          {/* plus decoration */}
          <div className="hidden md:block md:col-span-1 relative">
          ...
          {/* accept invitation */}
          <div className="col-span-12 md:col-span-5">
            <div className="button-container w-4/5 lg:w-3/5 mx-auto mb-6">
              <button
            ...
            <div className="button-container w-4/5 lg:w-3/5 mx-auto">
              <button
                className="button button-black font-medium w-full"
